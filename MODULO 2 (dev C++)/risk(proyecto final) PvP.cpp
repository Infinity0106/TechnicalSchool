...
main()
{
	int jugadores,i=0,op,tropas, persona=1,ataque,op1,opcion,jugar,vecesatacar,j,estado=1,opat=1,defensor,am1,am2,am3,dm1,dm2,opcion1=0;
		printf("******RISK******");
		printf("\nRisk es un juego como ningun otro. Es divertido como juego casual entre amigos, asi como un juego serio de estrategia con estudiantes dedicados por todo el mundo. El objetivo de risk es conquistar el mundo al controlar todo el territorio del tablero, que es un mapa del mundo. Dado que no puedes dominar el mundo en la vida real, ¿por que no hacerlo en un juego de mesa?");
